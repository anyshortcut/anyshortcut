<template>
  <div class="bind-view" :style="{ height: height }">
    <primary-bind :shortcuts="shortcuts" v-if="bindType === 'primary'"> </primary-bind>
    <compound-bind v-else-if="bindType === 'compound'" :shortcuts="compoundShortcuts">
    </compound-bind>
    <div class="bind-nav-bar" v-if="prefs.isCompoundShortcutEnable()">
      <div :class="{ active: bindType === 'primary' }" @click="bindType = 'primary'">
        Primary shortcut
      </div>
      <div :class="{ active: bindType === 'compound' }" @click="bindType = 'compound'">
        Compound shortcut
      </div>
    </div>
  </div>
