    ...
    <div class="shortcut-card" v-if="shortcut">
      <div class="top-container">
        ...
        <p class="text">
          <template v-if="shortcut.parentKey.length === 1">
            <shortcut-key :key-char="shortcut.key" :parentKeyChar="shortcut.parentKey">
            </shortcut-key>
            <span> / </span>
          </template>
      ...
      <div class="skewed-container">
        <div class="secondary-stats">
          <div class="entry" id="secondary-open-times">
          ...
          <div class="entry" id="secondary-save-time">
            <i class="icon-clock" aria-hidden="true"></i>
            <p v-if="shortcut.open_times > 100">
              {{ (shortcut.open_times * 3) / 60.0 }}
              <small>minutes</small>
            </p>
            <p v-else>
              {{ shortcut.open_times * 3 }}
              <small>seconds</small>
            </p>
          </div>
        ...
        <div id="delete-secondary-text" class="delete-text">Delete shortcut?</div>
      </div>
      <img
        class="right-arrow"
