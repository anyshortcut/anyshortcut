<template>
  <div class="keyboard">
    <div class="keyboard-row">
      ...
      <div v-for="key in '1234567890'" :key="key" :class="keyClass(key)" class="key">{{ key }}</div>
      <div class="key slide-key" v-visible="slideKeyVisibility"></div>
    </div>
    <div class="keyboard-row">
      <div class="key slide-key" v-visible="slideKeyVisibility"></div>
      <div v-for="key in 'QWERTYUIOP'" :key="key" :class="keyClass(key)" class="key">{{ key }}</div>
      <div class="key slide-key" v-visible="slideKeyVisibility"></div>
    </div>
    <div class="keyboard-row">
      <div class="key slide-key extra-size-two" v-visible="slideKeyVisibility"></div>
      <div v-for="key in 'ASDFGHJKL'" :key="key" :class="keyClass(key)" class="key">{{ key }}</div>
      <div class="key slide-key extra-size-two" v-visible="slideKeyVisibility"></div>
    </div>
    <div class="keyboard-row">
      <div
        class="key slide-key double-size lowercase"
        :class="{ highlight: combinationKey === 'shift' }"
        v-visible="slideKeyVisibility"
      >
        {{ combinationKey === 'shift' ? 'shift' : '' }}
      </div>
      <div v-for="key in 'ZXCVBNM'" :key="key" :class="keyClass(key)" class="key">{{ key }}</div>
      <div class="key slide-key" v-visible="slideKeyVisibility"></div>
      <div
        class="key slide-key double-size lowercase"
        :class="{ highlight: combinationKey === 'shift' }"
    ...
    <div class="keyboard-row">
      <div class="key slide-key lowercase" v-visible="slideKeyVisibility"></div>
      <div
        class="key slide-key lower-center lowercase"
      ...
      <div
        class="key slide-key lower-center lowercase extra-size-two"
        v-visible="slideKeyVisibility"
      ></div>
      <div class="key slide-key space-bar" v-visible="slideKeyVisibility"></div>
      <div
        class="key slide-key lower-center lowercase extra-size-two"
        v-visible="slideKeyVisibility"
      ></div>
